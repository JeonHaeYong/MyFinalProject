...
public class GyeonggiDTO {
	...
	private String LOCPLC_FACLT_TELNO; // 전화번호
	private String LOCPLC_AR_INFO;
	private String LOCPLC_ZIP_CD;
	private String ROADNM_ZIP_CD; // 도로명 우편번호
	private String REFINE_ROADNM_ADDR; // 도로명 주소
	private String REFINE_LOTNO_ADDR; // 지번주소
	private String REFINE_ZIP_CD; // 지번 우편번호
	...
	private String STOCKRS_DUTY_DIV_NM;
	private String SFRMPROD_PROCSBIZ_DIV_NM;
	private String STOCKRS_IDNTFY_NO;
	private String RIGHT_MAINBD_IDNTFY_NO;
	private String TOT_EMPLY_CNT;
	public GyeonggiDTO() {
		super();
		// TODO Auto-generated constructor stub
	}
	public GyeonggiDTO(String sIGUN_CD, String sIGUN_NM, String bIZPLC_NM, String lICENSG_DE, String lICENSG_CANCL_DE,
