                    ...
                    <div class="modal-body" id="body">
                        <form action="login" id="loginform" name="formname" method="post">
                            <div class="form-group">
                                ...
                                <input       type="text" class="form-control" id="joinemail" placeholder="ID를 입력하시오" required name="id"   >
                            </div>
                            <div class="form-group">
                            ...
                            <div id="loginwrapper">
                                ...
                                <div id="search_and_join" align="center" class="col pb-1 pb-1">
                                    ...
                                    <div id="search"><a href="findId"class="pr-3">아이디 찾기</a>| <a class="p1-3 pr-3 " href="findId"> 비밀번호 찾기</a>| 
                                    <a href=join class="pl-3" target="_blank">회원가입 </a></div>
                                    <hr>
                                </div>
                                <div id="naverlogin" >
                                    <a href="${url}"> <img src="resources/images/member/naver.png"  class="col pb-2 pl-3"  alt="네이버 이미지" id="loginimg" /></a>
                                </div>
                                <div id="kakaologin">
                                    <a
...
//날씨
            var apiURI = "http://api.openweathermap.org/data/2.5/weather?q=Busan&appid=078b2ce4ce1dc66e407d2f265bdfdd41";
    		$.ajax({
    			url : apiURI,
    			dataType : "json",
    			type : "GET",
