		...
		<div class="modal-content">
			...
			<div class="modal-body" id="body">
				<form action="login" id="loginform" name="formname" method="post">
					...
					<div id="loginwrapper">
						<div id="login">
							<input type="submit" id="loginbtn" class="col pl-2 pr-2"
								value="login">
						</div>
						<div id="search_and_join" align="center" class="col pb-1 pb-1">
							...
							<div id="search">
								<a href="findId" class="pr-3">아이디 찾기</a>| <a class="p1-3 pr-3 "
									href="findId"> 비밀번호 찾기</a>| <a href=join class="pl-3"
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					<div class="col-12">
						<img class="mr-3" src="/resources/images/doglogo2.png"
							width="50px" style="float: left;">
						<h2 class="footer-heading ml-4 mb-4"
							style="font-family: 'Gamja Flower'; font-size: 27px">라온펫</h2>
						<p
				...
				<div class="border-top pt-3">
					<p>
						...
						All rights reserved | This template is made with <i
							class="icon-heart-o" aria-hidden="true"></i>
					</p>
