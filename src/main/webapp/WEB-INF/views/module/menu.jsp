			...
			<div class="row  align-items-center">
				<div id="site_logo_col" class="col-6 col-xl-2">
					<h1 class="mb-0 site-logo">
						<a href="/" class="h2 mb-0" style="font-family:Gamja Flower;"><img id="site_logo_img" src="/resources/images/doglogo2.png" width="80px" height="80px"><strong>라온</strong>펫</a>
					</h1>
				</div>
				<div class="col-8 col-xl-10  d-none d-xl-block pr-0">
					<nav class="site-navigation position-relative text-right pl-0"
						...
						<ul	class="site-menu main-menu js-clone-nav ml-0 mr-0 pl-0 d-none d-lg-block">
							...
							<li><a href="toAbandoned?currentPage=1" class="nav-link menu-animal">유기동물</a></li>
							<li><a href="toDisappearList?currentPage=1" class="nav-link " id="menu-disappear">실종신고</a></li>

							<li><a href="toReviewList" class="nav-link">재회</a></li>
							<li><a href="freeMarket?currentPage=1&category=all"
								class="nav-link">무료나눔</a></li>
							<li><a href="/oxQuiz" class="nav-link menu-fun">Fun</a></li>
