						,
						[ "4780000", "4670000", "4710000", "4700000",
								"4740000", "4790000", "4770000", "4720000",
								"4680000", "4760000", "4750000", "4640000",
								"4690000", "4730000" ]
						// 전라남도 6460000 	
						,
						[ "4920000", "4880000", "4860000", "4840000",
								"4870000", "4830000", "4850000", "4800000",
								"4950000", "4890000", "4820000", "5010000",
								"4810000", "4970000", "4940000", "4990000",
								"4980000", "4910000", "5000000", "4960000",
								"4930000", "4900000" ]
						// 경상북도 6470000	
						,
						[ "5130000", "5050000", "5200000", "5080000",
								"5140000", "5060000", "5120000", "5240000",
								"5110000", "5210000", "5070000", "5180000",
								"5170000", "5090000", "5100000", "5230000",
								"5260000", "5250000", "5150000", "5190000",
								"5160000", "5220000", "5020000" ]
						// 경상남도 6480000	
						,
						[ "5370000", "5470000", "5420000", "5350000",
								"5430000", "5360000", "5340000", "5450000",
								"5380000", "5390000", "5310000", "5410000",
								"5280000", "5670000", "5320000", "5330000",
								"5440000", "5400000", "5460000", "5480000" ]
						// 제주특별자치도 6500000	
						, [ "6520000", "6510000" ] ];
				...
				$(".op_sido").each(function(i, item) {
					if ($(item).val() == "${dto.sido}") {
						$(item).attr("selected", true);
					}
				});
				sidoSelected();
				$(".op_sigungu").each(function(i, item) {
					if ($(item).val() == "${dto.sigungu}") {
						$(item).attr("selected", true);
					}
				});

				$("#findDate").val("${findDateString}");
				$(".op_sex").each(function(i, item) {
					if ($(item).val() == "${dto.sex}") {
						$(item).attr("selected", true);
					}
				});
			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-9 col-sm-12 col-12 row">
					<div class="text-center"
						style="margin: auto; font-size: 40px; color: #754F44; font-family: 'SeoulNamsanM'; margin-bottom: 40px;">
						임시보호중</div>
					<div style="width:100%; margin:auto;">
						<form action="modifyTempProtect?seq=${dto.seq }" method="post"
							enctype="multipart/form-data">

							<table class="table table-borderless"
								style="font-family: 'SeoulNamsanM'; color: #754F44;">
								<tbody>
									<tr>
									...
									<tr>
										...
										<td rowspan="2"></td>
										<td rowspan="2">
											<!-- 									<img id="showImg" --> <!-- 										src="http://upload.wikimedia.org/wikipedia/commons/c/ce/Transparent.gif" -->
											<!-- 										style="width: 200px; height: 150px"> --> <img
											id="showImg" src="${dto.imagePath }"
									...
									<tr>
										...
										<td><input id="findDate" type="date" max="${todayStr }"
											name="findDateString" placeholder="${dto.findDate }" required></td>
							...
							<div class="text-center">
								...
								<button type="button" id="cancel" class="btn btn-sm"
