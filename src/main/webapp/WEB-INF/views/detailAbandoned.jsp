		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-12 col-12 row">
				...
				<table class="table">
					<tbody>
						<tr>
							「동물보호법」 제17조, 같은 법 시행령 제7조 및 같은 법 시행규칙 제20조에 따라 구조된 동물의
								보호상황을 아래와 같이 공고합니다.
						</tr>
						...
						<tr>
							...
							<td><fmt:formatDate value="${dto.happenDt }" pattern="yyyy-MM-dd" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								...
								~ <fmt:formatDate value="${dto.noticeEdt }" pattern="yyyy-MM-dd" />
							</td>
						</tr>
						<tr>
							<th></th>
